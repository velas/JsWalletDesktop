...
(function(){
  ...
  ref$ = require('./pages/confirmation.js'), confirm = ref$.confirm, prompt = ref$.prompt, alert = ref$.alert, notify = ref$.notify, promptPassword = ref$.promptPassword, promptChooseToken = ref$.promptChooseToken;
