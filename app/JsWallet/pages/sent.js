...
(function(){
  ...
  module.exports = function(arg$){
    var store, web3t, style, textStyle, buttonPrimary3Style, linkStyle, sentIcon, btnIcon, hasPending, now, noRecent, ref$, inacurate, goHome, lang, children;
    ...
    store.transactions.applied));
    console.log('time-difference', (ref$ = store.transactions.applied[0]) != null ? ref$.time : void 8, moment().unix());
