...
(function(){
  ...
  nolocksContent = function(store, web3t){
    var info, style, goBack, lang, pairs, becomeValidator, changeAddress, changeStake, getBalance, getOptions, useMin, useMax, voteForChange, yourBalance, yourStakingAmount, yourStaking, vlxToken, chooseNolock, buildNolock, cancelPool, refresh, iconStyle, stakerPoolStyle, stats, children;
