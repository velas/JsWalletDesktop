...
(function(){
  var react, reactDom, navigate, getPrimaryInfo, web3, bignumber, getLang, historyFuncs, queryPools, icon, ref$, map, split, filter, find, foldl, sortBy, unique, head, each, div, times, plus, minus, velasNodeTemplate, hdkey, bip39, md5, menuFuncs, btoa, Buffer, copiedInform, copy, round5, ethToVlx, vlxToEth, switchAccount, roundHuman, exitStake, icons, placeholder, claimStake, canMakeStaking, epoch, alert, button, addressHolder, alertTxn, amountField, moveStake, seedmem, burger, stakeAccounts, cb, asCallback, getPair, toKeystore, showValidator, stakingContent, poolChosing, stringify, toString$ = {}.toString;
  react = require('react');
  ...
  stakingContent = function(store, web3t){
    ...
    buildStaker = function(store, web3t){
      return function(item){
        var checked, stake, myStake, index, choosePull, toEth, reward, filled, filledColor, vlx_native, wallet, votePower, mystakeClass, children;
        ...
        return react.createElement('tr', {
          ...
          react.createElement('td', {}, children = react.createElement('span', {
            ...
            store: store,
            wallet: wallet
          })), react.createElement('td', {}, ' ' + stake), react.createElement('td', {}, ' ' + item.validatorProbability), react.createElement('td', {
            className: mystakeClass + ""
          }, ' ' + stringify(myStake)), react.createElement('td', {}, ' ' + item.stakers), react.createElement('td', {}, children = button({
            store: store,
            onClick: choosePull,
            type: 'secondary',
            icon: 'arrowRight'
      ...
      react.createElement('div', {
        ...
        alertTxn({
          ...
          react.createElement('div', {
            ...
            react.createElement('h3', {}, ' Validators'), react.createElement('div', {}, children = react.createElement('div', {
              onClick: refresh,
              style: iconStyle,
              title: "refresh",
            ...
            react.createElement('thead', {}, children = react.createElement('tr', {}, children = [
              ...
              }, ' Validator'), react.createElement('td', {
                width: "25%",
                style: stats
              }, ' ' + lang.totalStake), react.createElement('td', {
                width: "5%",
                style: stats
              }, ' ' + "Validator probability"), react.createElement('td', {
                width: "25%",
                style: stats
        ...
        react.createElement('div', {
          className: 'title'
        }, children = react.createElement('h3', {}, ' Pool')), react.createElement('div', {
  ...
  poolChosing = function(arg$){
    ...
    return react.createElement('div', {
      className: 'staking staking37132359'
    }, children = [
      react.createElement('div', {
        style: borderStyle,
        className: 'title'
