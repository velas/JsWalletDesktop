...
(function(){
  var react, sendFuncs, ref$, map, find, keys, filter, pairsToObj, objToPairs, getPrimaryInfo, icon, getLang, switchAccount, icons, roundHuman, roundNumber, walletsFuncs, epoch, button, addressHolder, identicon, trxFee, sendContract, historyFuncs, burger, amountField, amountFiatField, networkSlider, times, BN, addresses, contracts, tokenNetworks, formGroup, send;
  react = require('react');
  ...
  amountFiatField = require('../components/amount-fiat-field.js');
  ...
  send = function(arg$){
    ...
    feeTokenDisplay = (function(){
      switch (false) {
      case feeToken !== 'VLX2' && feeToken !== 'VLX_EVM' && feeToken !== 'VLX_NATIVE':
        return 'VLX';
    ...
    title = store.current.send.swap !== true ? lang.send : 'Swap';
    return react.createElement('div', {
      className: 'content content-1138766249'
    }, children = [
          ...
          formGroup('sender', lang.from, iconStyle, function(){
            ...
            return react.createElement('div', {}, children = [
              react.createElement('div', {
                ...
                ]), activeUsd === 'active' ? amountFiatField({
                  store: store,
            ...
            react.createElement('tr', {}, children = [
              react.createElement('td', {}, ' ' + lang.youSpend), react.createElement('td', {}, children = [
                react.createElement('span', {
                  ...
                  className: 'usd'
                }, ' $ ' + roundHuman(send.amountChargedUsd))
              ])
              ...
              react.createElement('td', {}, ' ' + lang.fee), react.createElement('td', {}, children = [
                ...
                }, ' ' + roundHuman(send.amountSendFee)), react.createElement('img', {
                  src: feeCoinImage + "",
                  className: 'label-coin'
                }), react.createElement('span', {
                  title: send.amountSendFee + ""
  ...
  module.exports.init = function(arg$, cb){
    var store, web3t, wallet, isSwapContract, contractAddress, networkType, networks, networkKeys, defaultNetwork, availableNetworks, walletSwapNetworksIds, wallets, currentWallet;
    store = arg$.store, web3t = arg$.web3t;
    ...
    return contracts.getHomeNetworkFee({
      ...
      var wallet, txFeeInWallet, bridgeFeeToken, secondWallet, sendTransaction;
      ...
      store.current.send.feeCoinImage = (function(){
        ...
        switch (false) {
        case wallet.network.txFeeIn == null:
          console.log("wallet.network.tx-fee-in", wallet.network.txFeeIn);
