...
ill-qr = (store, web3t)->
    react.create-element 'div', { className: 'ill-qr' }, children = 
        react.create-element 'img', { src: "#{icons.invoice-ill-top}", className: 'ill ill-top' }
        react.create-element 'img', { src: "#{icons.invoice-ill-middle}", className: 'ill ill-middle move' }
        react.create-element 'img', { src: "#{icons.invoice-ill-down}", className: 'ill' }
send = ({ store, web3t })->
    { wallet, cancel } = invoice-funcs store, web3t
    react.create-element 'div', { className: 'content content-1460191937' }, children = 
        ill-qr store, web3t
        address-link store, web3t
