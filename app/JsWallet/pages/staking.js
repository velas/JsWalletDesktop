...
(function(){
  ...
  stakingContent = function(store, web3t){
    ...
    becomeOrExtendValidator = function(stake, pairs, cb){
      return web3t.velas.Staking.getStakerPools(pairs.staking.address, function(err, pool){
        if (err != null) {
          return cb(err);
        }
    ...
    getOptions = function(cb){
      return web3t.velas.Staking.candidateMinStake(function(err, data){
        ...
        min = (function(){
          switch (false) {
          case !(+store.staking.stakeAmountTotal >= 1000000):
            return 1;
          default:
  ...
  staking = function(arg$){
    ...
    return react.createElement('div', {
      className: 'staking staking326569540'
    }, children = [
      react.createElement('div', {
        style: borderStyle,
        className: 'title'
