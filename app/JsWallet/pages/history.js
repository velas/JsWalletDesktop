...
(function(){
  var react, ref$, sortBy, reverse, filter, map, find, take, objToPairs, historyFuncs, getPrimaryInfo, getLang, icon, loading, CopyToClipboard, copiedInform, copy, icons, MiddleEllipsis, addressHolder, roundNumber, loader, renderTransaction;
  react = require('react');
  ...
  loading = require('../components/popups/loading.js');
  loader = function(arg$){
  ...
  module.exports = function(arg$){
    var store, web3t, ref$, goBack, switchTypeIn, switchTypeOut, switchSender, switchReceiver, removeTypeFromFilter, removeFilterRaram, coins, isActive, switchFilter, style, lang, headerStyle, icon2, headerStyleLight, buttonStyle, filterStyle, split, menuStyle, borderB, borderT, filterBody, inputStyle, buttonPrimary3Style, buttonPrimary1Style, lightText, nothingIcon, headerTableStyle, iconFilter, expandCollapse, length, rowRenderer, buildTypes, buildFilterItems, historyWidth, historyHeight, onSenderFilter, onReceiverFilter, sendFrom, sendTo, children, coin;
    store = arg$.store, web3t = arg$.web3t;
    ...
    return react.createElement('div', {
      className: 'normalheader history history95075167'
    }, children = [
      react.createElement('div', {
        ...
        take(30)(
        store.transactions.applied))), length === 0 && store.current.transactionsAreLoading !== true ? react.createElement('div', {
          style: menuStyle,
