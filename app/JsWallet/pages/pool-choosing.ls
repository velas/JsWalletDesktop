    ...
    react.create-element 'div', { className: 'staking-content delegate' }, children = 
            ...
            react.create-element 'div', { id: "pools", className: 'form-group' }, children = 
                ...
                react.create-element 'div', { className: 'section' }, children = 
                    react.create-element 'div', { className: 'title' }, children = 
                        react.create-element 'h3', {}, ' Validators'
                        ...
                        react.create-element 'table', {}, children = 
                            react.create-element 'thead', {}, children = 
                                react.create-element 'tr', {}, children = 
                                    ...
                                    react.create-element 'td', { width: "10%", style: staker-pool-style }, ' Validator'
                                    react.create-element 'td', { width: "25%", style: stats }, ' ' + lang.total-stake
                                    react.create-element 'td', { width: "5%", style: stats }, ' ' + "Validator probability"
                                    react.create-element 'td', { width: "25%", style: stats }, ' ' + lang.my-stake
                                    react.create-element 'td', { width: "5%", style: stats }, ' ' + lang.stakers
                                    react.create-element 'td', { width: "4%", style: stats }, ' ' + lang.selectPool
        ...
        react.create-element 'div', { id: "choosen-pull", className: 'single-section form-group' }, children = 
            react.create-element 'div', { className: 'section' }, children = 
                ...
                react.create-element 'div', { title: "#{store.staking.chosen-pool.address}", className: 'chosen-pool' }, children = 
...
pool-chosing = ({ store, web3t })->
    ...
    react.create-element 'div', { className: 'staking staking37132359' }, children = 
