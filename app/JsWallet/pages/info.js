...
(function(){
  var react, reactDom, navigate, getPrimaryInfo, web3, getLang, historyFuncs, icon, switchAccount, icons, choosestaker, stakerStats, stakerStats2, stakerStats3, ref$, map, foldl, plus, div, roundHuman, epoch, alertTxn, burger, totalPool, totalStakers, stakingAmount, myStake, chartAmountSizes, chartStakersCounts, info, feelReward, feelRewards, slice$ = [].slice;
  react = require('react');
  ...
  ref$ = require('prelude-ls'), map = ref$.map, foldl = ref$.foldl;
  ...
  info = function(arg$){
    ...
    return react.createElement('div', {
      className: 'stats stats1628272092'
    }, children = [
      alertTxn({
        store: store
      }), react.createElement('div', {
