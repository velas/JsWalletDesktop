...
(function(){
  ...
  DECIMAL_SEPARATOR = '.';
  trxFee = function(arg$){
    var store, web3t, wallet, style, lang, send, activeCheap, activeCustom, activeAuto, activeClass, decimalsLimit, ref$, ref1$, chooseCheap, chooseCustom, chooseAuto, hasSendError, disabledClass, selectCustom, getNumber, valueWithoutDecimalWithDot, onChangeInternal, feeCurrency, tokenDisplay, borderStyle, text, inputStyle, customFeeValue, cheapOption, customOption, autoOption, children;
    ...
    tokenDisplay = feeCurrency === 'vlx2' ? 'vlx' : feeCurrency;
    borderStyle = {
    ...
    return react.createElement('div', {
      className: disabledClass + " trx-fee trx-fee125099688"
    }, children = [
