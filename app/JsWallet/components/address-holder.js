...
(function(){
  var react, ref$, getAddressLink, getAddressTitle, getAddressDisplay, MiddleEllipsis, getPrimaryInfo, icons, identicon, copy, contracts;
  react = require('react');
  ...
  module.exports = function(arg$){
    var store, wallet, type, text, style, addressSuffix, addressInput, addressInputBg, input, filterIcon, icon1, addressLink, addressTitle, addressDisplay, showDetails, hideDetails, active, rotateAddressSuffix, getAddress, address, isContract, children;
    store = arg$.store, wallet = arg$.wallet, type = arg$.type, text = arg$.text;
