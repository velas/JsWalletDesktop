...
(function(){
  ...
  module.exports = function(arg$){
    var store, type, disabled, config, array, newArray, page, ref$, perPage, allPages, style, page$, entities, prevButtonDisabled, nextButtonDisabled, $class, goBack, goForward, normalizeCurrentPage, setPerPage, switchPerPageSelector, closePerPageSelector, children;
