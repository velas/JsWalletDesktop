...
(function(){
  var react, money, ref$, each, filter, foldl, map, objToPairs, groupBy, keys, walletFuncs, getLang, plus, icon, getPrimaryInfo, get, icons, roundHuman, alert, button, addressHolder, walletStats, loading, confirm, baseArray, cb;
  react = require('react');
  ...
  module.exports = curry$(function(store, web3t, wallets, wallet){
    ...
    if (wallets == null || wallet == null) {
      ...
      return react.createElement('div', {
        key: "no-details",
        style: walletStyle,
        className: 'wallet-detailed wallet-detailed152437774'
    ...
    uriProd = "https://buy.velas.com/?address=" + wallet.address + "&crypto_currency=" + token + "&env=" + locationWallet;
    uriTest = "https://fiat-payments.testnet.velas.com/?address=" + wallet.address + "&crypto_currency=" + token + "&env=" + locationWallet;
    uri_buy = (function(){
      switch (false) {
      ...
      react.createElement('div', {
        ...
        react.createElement('div', {
          ...
          react.createElement('div', {}, children = [
            ...
            }, ' ' + name), !in$(wallet != null ? (ref3$ = wallet.coin) != null ? ref3$.token : void 8 : void 8, baseArray) ? react.createElement('span', {
          ...
          ? react.createElement('div', {
            ...
            react.createElement('div', {
              ...
              (wallet != null ? (ref7$ = wallet.coin) != null ? ref7$.token : void 8 : void 8) === "vlx_native" ? button({
                store: store,
