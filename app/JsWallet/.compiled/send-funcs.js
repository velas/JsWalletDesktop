      ...
      return createTransaction(txObj, function(err, txData){
        ...
        return confirm(store, parts[0], function(agree){
          ...
          return pushTx((import$({
            ...
            if (err != null) {
              if (err.toString().indexOf("Insufficient priority. Code:-26. Please try to increase fee")) {
                store.current.send.error = err;
                setTimeout(function(){
                  return store.current.send.error = "";
                }, 2000);
              }
              if (err.toString().indexOf("Unexpected token < in JSON at position 0")) {
