...
(function(){
  var observer, observable, react, pages, header, mobilemenu, defaultAlert, leftMenu, description, window, copyMessage, modalControl, getPrimaryInfo, confirmationControl, hoveredAddress, ref$, Offline, Online, defineRoot;
  ...
  module.exports = function(arg$){
    var store, web3t, currentPage, theme, style, syncing, openMenu, children;
    ...
    return react.createElement('div', {}, children = [
      defineRoot(store), description(store), react.createElement('div', {
        ...
        modalControl(store, web3t), confirmationControl(store, web3t), copyMessage(store, web3t), defaultAlert(store), false ? store.current.device === 'mobile' ? header(store, web3t) : void 8 : void 8, store.current.device === 'mobile' ? mobilemenu(store, web3t) : void 8, store.current.device === 'desktop' ? leftMenu(store, web3t) : void 8, currentPage({
          store: store,
          web3t: web3t
        }), hoveredAddress({
          store: store
        }), react.createElement(Offline, {}, children = react.createElement('div', {
