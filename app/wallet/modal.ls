...
export modal-control = (store)->
    ...
    coin-type =
        "#{store.ask.type}-type"
    react.create-element 'div', { key: "modal-container", className: 'modal-container modal-container-994859877' }, children = 
        react.create-element 'div', { className: 'modal' }, children = 
            ...
            react.create-element 'div', { className: 'install-body' }, children = 
