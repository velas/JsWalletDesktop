...
module.exports = ({ store, web3t } )->
    ...
    input-style=
        ...
        background: style.app.wallet
        border: "0"
    react.create-element 'div', { className: 'manage-account manage-account1606302824' }, children = 
        react.create-element 'div', { style: account-body-style, className: 'account-body' }, children = 
            react.create-element 'div', { style: account-body-style, className: 'title' }, children = 
                react.create-element 'div', {}, children = 
                    react.create-element 'div', {}, ' ' + lang.plugin-registry
                    react.create-element 'div', { on-click: close, className: 'close' }, ' x'
                react.create-element 'div', {}, children = 
