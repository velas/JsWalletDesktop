        ...
        react.create-element 'div', { className: 'box' }, children = 
            ...
            react.create-element 'div', {}, children = 
                switch store.current.status
                    case \verify
                        react.create-element 'div', {}, ' ' + lang.verify-nickname ? 'Nickname Verification...'
                    case \buy-nickname
                        react.create-element 'div', {}, ' ' + lang.get-nickname ? 'Get Nickname'
                    else
                        react.create-element 'button', { on-click: buy-nickname-click }, ' ' + lang.register ? 'Register'