...
manage-account = (store, web3t)->
    ...
    change-lang-kr = ->
        return set-lang \kr
    active =
        if store.langs[store.lang] then \active else \ ""
    comming-soon =
        opacity: ".3"
        cursor: "no-drop"
    ...
    react.create-element 'div', {}, children = 
        react.create-element 'div', { className: 'section' }, children = 
            react.create-element 'div', { style: color, className: 'title' }, ' Language'
            react.create-element 'div', { on-click: change-lang-en, style: color, className: 'lang-item' }, children = 
                """ English"""
                react.create-element 'img', { src: "#{langs.en}" }
            react.create-element 'div', { on-click: change-lang-ru, style: color, className: 'lang-item' }, children = 
                """ Русский"""
                react.create-element 'img', { src: "#{langs.ru}" }
            react.create-element 'div', { on-click: change-lang-ua, style: color, className: 'lang-item' }, children = 
                """ Український"""
                react.create-element 'img', { src: "#{langs.ua}" }
            react.create-element 'div', { on-click: change-lang-kr, style: color, className: 'lang-item' }, children = 
                """ 한국어"""
                react.create-element 'img', { src: "#{langs.cn}" }
            react.create-element 'div', { on-click: change-lang-cn, style: color, className: 'lang-item' }, children = 
                """ 中文語言"""
                react.create-element 'img', { src: "#{langs.kr}" }
            react.create-element 'div', { style: comming-soon, className: 'lang-item' }, children = 
                """ Le français"""
                react.create-element 'img', { src: "#{langs.fr}" }
        react.create-element 'div', { className: 'section' }, children = 
...
module.exports = ({ store, web3t } )->
    ...
    lang = get-lang store
    react.create-element 'div', { className: 'settings-menu settings-menu-866280290' }, children = 
